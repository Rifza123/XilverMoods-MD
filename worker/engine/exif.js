...
const fs = await r('fs')
const { tmpdir } = await r("os")
const Crypto = await r("crypto")
const { default:ff } = await r('fluent-ffmpeg')
const { default:webp } = await r("node-webpmux")
const { default:path } = await r("path")
...
export { imageToWebp, videoToWebp, writeExifImg, writeExifVid, writeExif, writeExifStc }
